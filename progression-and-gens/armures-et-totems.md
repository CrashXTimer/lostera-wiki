...
Les armures de LostEra apportent un boost direct à une **monnaie spécifique**. Elles s'achètent avec des **Fragments**, une monnaie obtenue en jouant sur les différents modes.

| Set               | Boost par pièce       |
| ----------------- | --------------------- |
| **Armure Money**  | +25% Money par pièce  |
| **Armure Orbes**  | +25% Orbes par pièce  |
| **Armure Gemmes** | +25% Gemmes par pièce |
| **Armure Perles** | +25% Perles par pièce |
